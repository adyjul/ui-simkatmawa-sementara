...
var colors = ['#007bff','#28a745','#333333','#c3e6cb','#dc3545','#6c757d'];
  ...
  var labels = dataChart.data.map((v)=>{
    return v.product
  });

  var data = dataChart.data.map((v)=>{
    return v.value
  })
...
var chartBarang = document.getElementById("chBar");

if (chBar) {
  console.log(chartBarang)
  var BarangA = {
    label: 'Barang A',
    data: [5427, 5243, 5514, 3933, 1326, 687, 1271, 1638],
    backgroundColor: 'rgba(0, 99, 132, 0.6)',
    borderWidth: 0,
    yAxisID: "y-axis-barangA"
  };
  
  var BarangB = {
    label: 'Barang B',
    data: [34, 89, 98, 37, 231, 90, 87, 110],
    backgroundColor: 'rgba(99, 132, 0, 0.6)',
    borderWidth: 0,
    yAxisID: "y-axis-barangB"
  };
  
  var planetData = {
    labels: labels,
    datasets: [BarangA, BarangB]
  };
  ...
  var barChart = new Chart(chartBarang, {
    type: 'bar',
    data: planetData,
...
// var chBar2 = document.getElementById("chBar-2");
// if (chBar2) {
//   new Chart(chBar2, {
//   type: 'bar',
//   data: {
